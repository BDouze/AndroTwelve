...
public final class ObdCommandDictionary {
    ...
    private static final ObdCommand[] DICTIONARY_ENTRIES_01 = new ObdCommand[] {
        ...
        new ObdCommand("0161", "4161", 0, new AffineObdResponseConverter(1.0, -125.0), "Driver's demand engine - percent torque", "%", ""),
        new ObdCommand("0162", "4162", 0, new AffineObdResponseConverter(1.0, -125.0), "Actual engine - percent torque", "%", ""),
        new ObdCommand("0163", "4163", 0, new AffineObdResponseConverter(1.0, 0.0),    "Engine reference torque", "N.m", ""),
        //ToDo: Implement affine byte array converter
        new ObdCommand("0164", "4164", 0, new DefaultObdResponseConverter(), "Engine percent torque data", "{%, %, %, %, %}", "A-125 Idle, B-125 Engine point 1, C-125 Engine point 2, D-125 Engine point 3, E-125 Engine point 4"),
        new ObdCommand("0165", "4165", 0, new DefaultObdResponseConverter(), "Auxiliary input / output supported", null, "Bit encoded"),
        //ToDo: Need more info about PIDs 0166 to 0187
        new ObdCommand("0166", "4166", 0, new DefaultObdResponseConverter(), "Mass air flow sensor", "UNIT", ""),
        new ObdCommand("0167", "4167", 0, new DefaultObdResponseConverter(), "Engine coolant temperature", "UNIT", ""),
        new ObdCommand("0168", "4168", 0, new DefaultObdResponseConverter(), "Intake air temperature sensor", "UNIT", ""),
        new ObdCommand("0169", "4169", 0, new DefaultObdResponseConverter(), "Commanded EGR and EGR Error", "UNIT", ""),
        new ObdCommand("016A", "416A", 0, new DefaultObdResponseConverter(), "Commanded Diesel intake air flow control and relative intake air flow position", "UNIT", ""),
        new ObdCommand("016B", "416B", 0, new DefaultObdResponseConverter(), "Exhaust gas recirculation temperature", "UNIT", ""),
        new ObdCommand("016C", "416C", 0, new DefaultObdResponseConverter(), "Commanded throttle actuator control and relative throttle position", "UNIT", ""),
        new ObdCommand("016D", "416D", 0, new DefaultObdResponseConverter(), "Fuel pressure control system", "UNIT", ""),
        new ObdCommand("016E", "416E", 0, new DefaultObdResponseConverter(), "Injection pressure control system", "UNIT", ""),
        new ObdCommand("016F", "416F", 0, new DefaultObdResponseConverter(), "Turbocharger compressor inlet pressure", "UNIT", ""),

        new ObdCommand("0170", "4170", 0, new DefaultObdResponseConverter(), "Boost pressure control", "UNIT", ""),
        new ObdCommand("0171", "4171", 0, new DefaultObdResponseConverter(), "Variable Geometry turbo (VGT) control", "UNIT", ""),
        new ObdCommand("0172", "4172", 0, new DefaultObdResponseConverter(), "Wastegate control", "UNIT", ""),
        new ObdCommand("0173", "4173", 0, new DefaultObdResponseConverter(), "Exhaust pressure", "UNIT", ""),
        new ObdCommand("0174", "4174", 0, new DefaultObdResponseConverter(), "Turbocharger RPM", "UNIT", ""),
        new ObdCommand("0175", "4175", 0, new DefaultObdResponseConverter(), "Turbocharger temperature", "UNIT", ""),
        new ObdCommand("0176", "4176", 0, new DefaultObdResponseConverter(), "Turbocharger temperature", "UNIT", ""),
        new ObdCommand("0177", "4177", 0, new DefaultObdResponseConverter(), "Charge air cooler temperature (CACT)", "UNIT", ""),
        new ObdCommand("0178", "4178", 0, new DefaultObdResponseConverter(), "Exhaust Gas temperature (EGT) Bank 1", "UNIT", ""),
        new ObdCommand("0179", "4179", 0, new DefaultObdResponseConverter(), "Exhaust Gas temperature (EGT) Bank 2", "UNIT", ""),
        new ObdCommand("017A", "417A", 0, new DefaultObdResponseConverter(), "Diesel particulate filter (DPF)", "UNIT", ""),
        new ObdCommand("017B", "417B", 0, new DefaultObdResponseConverter(), "Diesel particulate filter (DPF)", "UNIT", ""),
        new ObdCommand("017C", "417C", 0, new DefaultObdResponseConverter(), "Diesel Particulate filter (DPF) temperature", "UNIT", ""),
        new ObdCommand("017D", "417D", 0, new DefaultObdResponseConverter(), "NOx NTE control area status", "UNIT", ""),
        new ObdCommand("017E", "417E", 0, new DefaultObdResponseConverter(), "PM NTE control area status", "UNIT", ""),
        new ObdCommand("017F", "417F", 0, new DefaultObdResponseConverter(), "Engine run time", "UNIT", ""),

        
        //ToDo: Implement bit mask converter
        new ObdCommand("0180", "4180", 0, new DefaultObdResponseConverter(), "PIDs supported [81 - A0]", null, "Bit mask"),
        new ObdCommand("0181", "4181", 0, new AffineObdResponseConverter(1.0, 0.0), "Engine run time for Auxiliary Emissions Control Device(AECD)", "UNIT", ""),
        new ObdCommand("0182", "4182", 0, new AffineObdResponseConverter(1.0, 0.0), "Engine run time for Auxiliary Emissions Control Device(AECD)", "UNIT", ""),
        new ObdCommand("0183", "4183", 0, new AffineObdResponseConverter(1.0, 0.0), "NOx sensor", "UNIT", ""),
        new ObdCommand("0184", "4184", 0, new AffineObdResponseConverter(1.0, 0.0), "Manifold surface temperature", "UNIT", ""),
        new ObdCommand("0185", "4185", 0, new AffineObdResponseConverter(1.0, 0.0), "NOx reagent system", "UNIT", ""),
        new ObdCommand("0186", "4186", 0, new AffineObdResponseConverter(1.0, 0.0), "Particulate matter (PM) sensor", "UNIT", ""),
        new ObdCommand("0187", "4187", 0, new AffineObdResponseConverter(1.0, 0.0), "Intake manifold absolute pressure", "UNIT", ""),
