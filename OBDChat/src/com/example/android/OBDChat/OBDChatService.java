...
public class OBDChatService {
    ...
    private static final UUID OBD_UUID_SECURE =
        UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
    private static final UUID OBD_UUID_INSECURE =
        UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
    ...
    /**
     * Constructor. Prepares a new OBDChat session.
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(OBDChat.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void start() {
        ...
        /* Comment out the creation of listen threads. Only active connect is made to OBD device
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(OBDChat.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(OBDChat.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(OBDChat.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);

        // Start the service over to restart listening mode
        OBDChatService.this.start();
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(OBDChat.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(OBDChat.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
